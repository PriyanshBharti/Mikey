...
PM_START_TEXT = """
`Hello` [🧚‍♀️](https://telegra.ph/file/ce5a434e3152f6a455341.jpg) `My name is` *Hinata*
`I am powerful  Anime theme group management bot.
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD HINATA TO YOUR GROUP ➕️", url="t.me/HinataHyuga_Robot?startgroup=true"
        ),
    ],
                         [
                         InlineKeyboardButton(
                         ...
                         InlineKeyboardButton(
                             text="🎉 Updates",
                             url="https://t.me/Hinataupdates"),
                         InlineKeyboardButton(
                             text="🗃 Guide",
                             url="https://t.me/Hinataupdates/5"),
...
HELP_STRINGS = """
`Hi.. I'm` [Hinata ⚙️]("https://telegra.ph/file/ce5a434e3152f6a455341.jpg") 
    ...
    if query.data == "asuna_":
        query.message.edit_text(
            text=""" ❗ I'm *Hinata*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\nIf you have any question about *Hinata*, let us know at [Support](https://t.me/HinataSupport) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..👸 I'm *Hinata*
                 \nHere is the [Source Code](https://t.me/hinatasupport) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
