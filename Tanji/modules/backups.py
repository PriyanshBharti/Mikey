...
import Tanji.modules.sql.notes_sql as sql
from Tanji import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Tanji.__main__ import DATA_IMPORT
...
# from Tanji.modules.rules import get_rules
import Tanji.modules.sql.rules_sql as rulessql

# from Tanji.modules.sql import warns_sql as warnssql
import Tanji.modules.sql.blacklist_sql as blacklistsql
from Tanji.modules.sql import disable_sql as disabledsql

# from Tanji.modules.sql import cust_filters_sql as filtersql
# import Tanji.modules.sql.welcome_sql as welcsql
import Tanji.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("Tanjirou{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Tanjirou{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `TanjirouKamado-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Tanjirou{}.backup".format(chat_id))  # Cleaning file
