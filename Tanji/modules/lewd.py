...
from Tanji import dispatcher, updater
import Tanji.modules.sql.nsfw_sql as sql
...
__help__ = """
Warning 🔞 !! This module is for 18+ not for kids , so if you under 18 you better stay away ‼️.

/addnsfw : Enable NSFW mode
/rmnsfw : Disable NSFW mode

**Note: You can't disable in pm, it's only for groups**
