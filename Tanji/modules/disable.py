...
from Tanji.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from Tanji.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from Tanji.modules.sql import disable_sql as sql
