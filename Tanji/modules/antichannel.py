...
from Tanji.modules.helper_funcs.decorators import TANJICMD, TANJIMSG
...
@TANJICMD(command="antichannelmode", group=100)
...
@TANJIMSG(Filters.chat_type.groups, group=110)
