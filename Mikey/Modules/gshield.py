...
from Tanji.confing import get_int_key, get_str_key
from Tanji.services.telethonbasics import is_admin
from Tanji.events import register
from pymongo import MongoClient
from Tanji.modules.sql.nsfw_watch_sql import (
    add_nsfwatch,
    get_all_nsfw_enabled_chat,
    is_nsfwatch_indb,
    rmnsfwatch,
)
from Tanji import telethn as tbot, MONGO_DB_URI, BOT_ID
