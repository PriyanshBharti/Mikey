...
from Tanji import aiohttpsession as aiosession
from Tanji.ex_plugins.dbfunctions import start_restart_stage
from Tanji.utils.http import get, post


async def restart(m: Message):
    if m:
        await start_restart_stage(m.chat.id, m.message_id)
    execvp(executable, [executable, "-m", "TanjiBot"])
...
def generate_captcha():
    ...
    height = 100
    correct_answer = ""
    font = ImageFont.truetype("Tanji/resources/default.ttf", 55)
    file = f"Tanji/resources/{randint(1000, 9999)}.jpg"
